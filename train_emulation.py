...
def _load_training_module():
    ...
    full_name = "car_dreamer.toolkit.emulation.training"
    if full_name in sys.modules:
        return sys.modules[full_name]
    spec = importlib.util.spec_from_file_location(full_name, EMULATION_ROOT / "training.py")
