...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--birdeye-dir", default=None,
                        help="directory of real CARLA birdeye dumps (data/birdeye_frames). When given, "
                             ...
                             "and overlays the policy graph's vehicles/objects; else a scatter.")
...
def main() -> int:
    ...
    bev = BevOptions(birdeye_dir=args.birdeye_dir, obs_range=args.bev_obs_range, ego_offset=args.bev_ego_offset)
    if args.html:
